...
func NewCourse(db *sql.DB) *Course {
	sts := "CREATE TABLE IF NOT EXISTS courses(id string, name string NOT NULL, description string, category_id string NOT NULL, FOREIGN KEY (category_id) REFERENCES categories (id));"
	_, err := db.Exec(sts)
	if err != nil {
		panic(err)
	}
